...
<div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="form-group">
                            <a class="btn btn-light" href="{{ route('frontend.coupons.index') }}">
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ trans('frontend.coupon.content.purchase_now') }}</div>
                <div class="card-body">
                    <p>
                        {{ trans('frontend.coupon.content.coupon_code_reserved') }}
                        <span id="timer">{{ (int)($timerSeconds / 60) }}:{{ ($timerSeconds % 60) < 10 ? '0' : '' }}{{ $timerSeconds % 60 }}</span>
                    </p>
                    <p>{{ trans('frontend.coupon.content.the_price_of_a_coupon') }}${{ $coupon->price }}.</p>
                    <form method="POST" action="{{ route('frontend.codes.purchase', $code) }}" class="card-form mt-3 mb-3">
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" class="btn btn-primary pay">
                                {{ trans('frontend.coupon.content.purchase') }}
                            </button>
                        </div>
                    </form>
                </div>
